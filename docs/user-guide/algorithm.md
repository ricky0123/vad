...
2. The converted samples are batched into "frames" of size determined automatically by the model (512 samples for the "v5" and "v6" models, 1536 samples for the "legacy" model).
