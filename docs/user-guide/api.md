...
| `onEmitChunk`                 | `(audio: Float32Array) => any`                                | `() => {}`                                      | Callback to run everytime numFramesToEmit new frames accumulates in the audio buffer after speech start is detected. Takes as arg a Float32Array with numFramesToEmit * frameSamples audio samples, sample rate 16000. If speech ends before enough frames accumulate, the Float32Array will contain only the frames accumulated since the last callback to onEmitChunk.                                 
...
| `endSpeechPadFrames`          | `number`                                                      | `1`                                              | [see algorithm configuration](algorithm.md#configuration)                                                                                                                                                         |
| `minSpeechFrames`             | `number`                                                      | `3`                                              | [see algorithm configuration](algorithm.md#configuration)                                                                                                                                                         | 
| `numFramesToEmit`             | `number`                                                      | `0`                                              | [see algorithm configuration](algorithm.md#configuration)                                                                                                                                                         |
